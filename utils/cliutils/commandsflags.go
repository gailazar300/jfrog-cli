...
var commandFlags = map[string][]string{
	...
	GoPublish: {
		deps, self, url, user, password, accessToken, buildName, buildNumber, module, project, detailedSummary,
	},
	Go: {
		noRegistry, publishDeps, buildName, buildNumber, module, project,
	},
	GoRecursivePublish: {
	...
	ReleaseBundleCreate: {
		url, distUrl, user, password, accessToken, sshKeyPath, sshPassPhrase, serverId, spec, specVars, targetProps,
